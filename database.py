...
class Database:
    ...
    def delete_character(
        ...
        # --------------------------------------------------
        # If deleted character was active,
        ...
        try:
            ...
            print(
                f"⚠️ Active character cleanup warning: {e}"
            )
    ...
    def get_ai_config(
        ...
        with self.lock:
            ...
            self.conn.execute(
                ...
                VALUES (?, 0, NULL, 'normal', 'mention',
                        NULL, 'management', 'google', ?,
                        1, 0, 0)
                """,
                (
                    int(guild_id),
