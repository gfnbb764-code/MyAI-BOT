...
async def on_message(
    ...
    # وصول إنسان = إعادة فتح جلسة Bot-to-Bot
    reset_bot_chat_session(
        message.channel.id
    )
    ...
    if reply_type == "bot_chat":
        ...
        # الإنسان لا يحتاج رد في هذا الوضع
        print(
            "🤖 BOT CHAT MODE | "
            "human message ignored."
        )
